...
against real release binaries and version-pinned docs for the supported CLI
lines.
...
Official docs for this snapshot: [v0.45.1](https://www.jj-vcs.dev/v0.45.1/)

---

## Status

This snapshot is written for **jj 0.45.1** (tag `using-jj/jj-0.45.1`).

If you run an older `jj --version`, open [`VERSIONS.md`](./skills/using-jj/VERSIONS.md)
or pin a tag (`using-jj/jj-0.45.0`, `using-jj/jj-0.44.0`, `using-jj/jj-0.43.0`, …).
...
Commands use current surfaces: `jj git init`, `jj bookmark`,
...
| [`VERSIONS.md`](./skills/using-jj/VERSIONS.md) | **0.45.1 notes** + what differs on older CLIs |
...
1. **This snapshot = jj 0.45.1.** Recipes and `SKILL.md` are present-tense for
   that line (same CLI as 0.45.0). Official docs: [v0.45.1](https://www.jj-vcs.dev/v0.45.1/).
